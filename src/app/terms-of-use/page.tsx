...
export const metadata: Metadata = {
  ...
  description: 'Terms of Use for New Image Dental website and services.',
}
...
export default function TermsOfUsePage() {
  return (
    <main className="mx-auto bg-[url(/media/dental-graphics.JPG)] px-3 py-12 md:px-24">
      ...
      <p className="mb-8 font-bold text-gray-800">
        BY ENTERING, ACCESSING, BROWSING, SUBMITTING INFORMATION TO, OR OTHERWISE USING THE SITE,
        YOU ACKNOWLEDGE AND AGREE TO THESE TERMS. IF YOU DO NOT AGREE TO THESE TERMS, YOU MAY NOT
      ...
      <p className="mb-4 text-sm text-gray-600 lg:text-base">
        ...
        relationship with the Practice. The Practice is not, through the use of the Site,
        recommending or endorsing any specific dental treatment for any dental condition, healthcare
        provider or medication.
      </p>
      ...
      <p className="mb-4 text-sm text-gray-600 lg:text-base">
        ...
        patient or returning patient appointments.
      </p>
      ...
      <div className="mb-4 space-y-4 text-sm text-gray-600 lg:text-base">
        <p>
          ...
          or objectionable conduct; (iii) you will not use the Site to cause nuisance, annoyance or
          inconvenience; (iv) you will not impair the proper operation of the Site; (v) you will not
          try to harm the Site in any way whatsoever; (vi) you will not copy or distribute the Site
          or any other content without written permission from us; and (vii) you will only use the
          Site for your internal operations and will not resell it to a third party or otherwise use
          it for commercial purposes.
        </p>
        <p>
          B. You agree to protect the Site, and its proprietary content, information and other
          materials, from any unauthorized access or use, and you agree that you will not use the
          Site, or such proprietary content, information or materials except as authorized in
          writing by the Practice. You agree that you will not directly or indirectly: (i)
          distribute, sell, assign, encumber, transfer, rent, lease, loan, sublicense, modify,
          time-share or otherwise exploit the Site in any unauthorized manner, including but not
          limited to by trespass or burdening network capacity; (ii) use the Site in any service
        ...
        <p>
          ...
          access to the Site, or any portion of the Site at any time without notice. In no event
          will the Practice be liable for the removal of or disabling of access to the Site or any
          portion thereof. The Practice may also impose limits on the use of or access to the Site,
      ...
      <div className="mb-4 space-y-4 text-sm text-gray-600 lg:text-base">
        ...
        <p>
          ...
          limitation, AT&T, Verizon Wireless, Sprint, T-Mobile, MetroPCS, and Mango Voice. Carriers
      ...
      <p className="mb-4 text-sm text-gray-600 lg:text-base">
        ...
        Practice does not make any warranties or representations regarding the use of the materials
        in the Site in terms of their correctness, accuracy, adequacy, usefulness, timeliness,
        reliability or otherwise. Some states do not permit limitations or exclusions on warranties,
      ...
      <div className="mb-4 space-y-4 text-sm text-gray-600 lg:text-base">
        <p className="font-bold uppercase">
          ...
          INVOLVED IN CREATING, PRODUCING, OR DELIVERING THE SITE OR ITS CONTENT, ARE LIABLE FOR ANY
          DIRECT, INDIRECT, PUNITIVE, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR OTHER DAMAGES ARISING
          OUT OF OR IN ANY WAY CONNECTED WITH THE USE OF THE SITE, WHETHER BASED ON CONTRACT, TORT,
      ...
      <p className="mb-4 text-sm text-gray-600 lg:text-base">
        ...
        international copyright laws. The Practice reserves all intellectual property rights not
      ...
      <p className="mb-4 font-bold text-gray-600 uppercase">
        BY ENTERING INTO THESE TERMS, YOU AND THE PRACTICE ACKNOWLEDGE AND AGREE TO WAIVE CERTAIN
        RIGHTS TO LITIGATE DISPUTES IN COURT, TO RECEIVE A JURY TRIAL OR TO PARTICIPATE AS A
        PLAINTIFF OR AS A CLASS MEMBER IN ANY CLAIM ON A CLASS OR CONSOLIDATED BASIS OR IN A
        REPRESENTATIVE CAPACITY. YOU AND THE PRACTICE BOTH AGREE THAT ANY ARBITRATION WILL BE
        CONDUCTED ON AN INDIVIDUAL BASIS AND NOT A CONSOLIDATED, CLASS-WIDE OR REPRESENTATIVE BASIS
        ...
        MEMBER IN ANY CLAIM ON A CLASS OR CONSOLIDATED BASIS OR IN A REPRESENTATIVE CAPACITY.
      </p>
      ...
      <p className="mb-4 text-sm text-gray-600 lg:text-base">
        ...
        arising out of, relating to or concerning these Terms and/or the Site or in which these
        Terms and/or the Site are a material fact.
      </p>
